...
document.querySelector(".quick-input-widget");
        if (commandDialog) {
          // Apply the blur effect immediately if the command dialog is 
visible
          if (commandDialog.style.display !== "none") {
            runMyScript();
          }
            // Create an DOM observer to 'listen' for changes in 
element's attribute.
...
mutation.attributeName === 'style') {
                        if (commandDialog.style.display === 'none') {
                            ...
                            // If the .quick-input-widget element 
(command palette) is in the DOM
                            // but no inline style display: none, show 
the backdrop blur.
                            runMyScript();
                        }
                    }
    ...
    function runMyScript() {
        ...
        const treeWidget = 
document.querySelector(".monaco-tree-sticky-container");
